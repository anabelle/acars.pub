...
## 6. Prime Directive
Every time you commit code, ask yourself: *"If 10,000 players fire this event simultaneously right now, will it break the math, melt the DOM, or desync the Nostr state?"* 
