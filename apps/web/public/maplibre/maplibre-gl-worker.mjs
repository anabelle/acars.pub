...
var W = class {
    ...
    update(e, t, n) {
      for (let t of e) {
        ...
        let e = (this._layers[t.id] = y(t, n));
        (e._featureFilter = k(e.filter, `layers[${t.id}].filter`, n)),
    ...
    constructor(e) {
      ...
      for (let n in e) {
        ...
        for (let e in r) {
          ...
          let s = t[n][e].rect;
          o.copy(i.bitmap, a, { x: 0, y: 0 }, { x: s.x + 1, y: s.y + 1 }, i.bitmap);
        }
      }
...
var K = class {
  ...
  async parse(e, t, n, r, i) {
    (this.data = e), (this.collisionBoxArray = new v());
    let a = new M(Object.keys(e.layers).sort()),
      o = new N(this.tileID, this.promoteId);
    o.bucketLayerIDs = [];
    let s = {},
      c = {
        featureIndex: o,
    ...
    for (let t in l) {
      ...
      for (let e = 0; e < r.length; e++) {
        let n = r.feature(e),
          a = o.getId(n, t);
        u.push({ feature: n, id: a, index: e, sourceLayerIndex: i });
      }
      for (let e of l[t]) {
        let t = e[0];
    ...
    let u = T(c.glyphDependencies, (e) => Object.keys(e));
    ...
    if (Object.keys(u).length) {
      ...
      this.inFlightDependencies.push(e),
        (f = r.sendAsync(
          {
            type: `GG`,
            data: { stacks: u, source: this.source, tileID: this.tileID, type: `glyphs` },
          },
          e,
        ));
    }
    let p = Object.keys(c.iconDependencies),
      h = Promise.resolve({});
    if (p.length) {
      let e = new AbortController();
      this.inFlightDependencies.push(e),
        (h = r.sendAsync(
          {
            type: `GI`,
            data: { icons: p, source: this.source, tileID: this.tileID, type: `icons` },
          },
          e,
        ));
    }
    let g = Object.keys(c.patternDependencies),
      _ = Promise.resolve({});
    if (g.length) {
      let e = new AbortController();
      this.inFlightDependencies.push(e),
        (_ = r.sendAsync(
          {
            type: `GI`,
            data: { icons: g, source: this.source, tileID: this.tileID, type: `patterns` },
          },
          e,
        ));
    }
    let y = c.dashDependencies,
      b = Promise.resolve({});
    if (Object.keys(y).length) {
      let e = new AbortController();
      this.inFlightDependencies.push(e), (b = r.sendAsync({ type: `GDA`, data: { dashes: y } }, e));
    }
    let [x, S, C, w] = await Promise.all([f, h, _, b]),
      E = new G(x),
      D = new d(S, C);
    for (let e in s) {
      let t = s[e];
...
var J = class {
  ...
  X = class {
    ...
    loadGeometry() {
      return this.pointsArray.map((e) => e.map((e) => new h(e.x, e.y)));
    }
  },
  ee = class {
    constructor(e, t, n) {
...
function ne(e, t, n) {
  ...
  for (let t = 0; t < e.length; t++) {
    ...
    (l = r(l, n.type, -128, -128, i + 128, i + 128)),
      l.length !== 0 && c.push(new X(n.type, l, n.properties, n.id, i));
  }
...
var re = class {
    constructor(e, t, n) {
      (this.actor = e),
        ...
        (this.overzoomedTileResultCache = new I(1e3));
    }
    loadVectorTile(t, n) {
      try {
        return { vectorTile: t.encoding === `mlt` ? new D(n) : new C(new B(n)), rawData: n };
      } catch (r) {
    ...
    async loadTile(e) {
      ...
      i.abort = a;
      try {
        let o = await _(e.request, a);
        if (e.etag && e.etag === o.etag)
          return this.tileState.finishLoading(t), this._getEtagUnmodifiedResult(o, r);
    ...
    async _parseWorkerTile(e, t) {
      ...
      if (n) {
        ...
        (r = R({ rawTileData: i.slice(0), encoding: s }, r, a, o)),
          this.tileState.removeParsing(e.uid);
      } else e.etag && (r = R(r, { etag: e.etag }));
      return r;
    }
  ...
  ie = class {
    ...
    async loadTile(e) {
      let {
        ...
        l = r.width + 4,
        u = r.height + 4,
        d = A(r) ? new i({ width: l, height: u }, await F(r, -2, -2, l, u)) : r,
        f = new b(t, d, n, a, o, s, c);
  ...
  ae = class {
    ...
    loadVectorTile(e) {
      ...
      if (!i) return null;
      let a = new x(i.features, { version: 2, extent: g });
      return { vectorTile: a, rawData: O(a, c).buffer };
    }
    async loadTile(e) {
      let { uid: t } = e,
        n = new K(e);
    ...
    async _parseWorkerTile(e, t) {
      ...
      if (n) {
        let { rawData: t } = n;
        (r = R({ rawTileData: t.slice(0), encoding: `mvt` }, r)),
          this.tileState.removeParsing(e.uid);
      }
      return r;
    }
    ...
    async loadAndProcessGeoJSON(e, t) {
      if ((e.request && (e.data = (await n(e.request, t)).data), e.data)) {
...
function oe(e, t) {
  let n = R(t.geojsonVtOptions || {}, { updateable: !0, clusterOptions: Z(t) });
  return new l(e, n);
}
function Z({ geojsonVtOptions: e, clusterProperties: t, source: n }) {
  ...
  for (let e of s) {
    let [a, o] = t[e],
      s = z(o, `sources.${n}.clusterProperties.${e}[1]`),
      c = z(
...
var $ = class {
  constructor(e) {
    (this.self = e),
      ...
      (this.self.addProtocol = p),
      (this.self.removeProtocol = t),
