...
export function Ticker() {
  ...
  return (
    <div className="pointer-events-none flex items-center space-x-6 overflow-hidden bg-background/95 backdrop-blur-sm border-t border-border px-4 py-1.5 text-xs font-mono text-muted-foreground z-50 fixed bottom-0 left-0 right-0 shadow-[0_-5px_15px_rgba(0,0,0,0.5)]">
