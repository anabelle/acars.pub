...
export default function HomeRoute() {
  ...
  // Keep the cockpit mounted across map<->cockpit switches and toggle
  // visibility instead of unmounting: every remount rebuilt its memos and
  // O(R+F) derived state, which made panel switching feel laggy.
  const cockpitVisible = panel === "cockpit";
  const showIntroCard = !cockpitVisible && panel !== "map" && !dismissed;

  return (
    <>
      <div className={cockpitVisible ? "contents" : "hidden"}>
        <OperationsCockpit />
      </div>
