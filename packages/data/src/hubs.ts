import type { HubTier } from "@acars/core";
...
export const getHubPricingForIata = (
  iata: string,
): { openFee: number; monthlyOpex: number; tier: HubTier } => {
